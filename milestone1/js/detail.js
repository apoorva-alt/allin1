...
const id= newURLSearchParams(window.location.search).get('id');
let container=document.querySelector('.details');
let delete1=document.querySelector('#delete');
console.log(delete1);
const renderDetails=async()=>{​​​​​​​​
const response=awaitfetch('http://localhost:3000/books/'+id);
const book= awaitresponse.json();
console.log(book);
let template=`
    <div class="card">
...
const res=awaitfetch('http://localhost:3000/books/'+id,{​​​​​​​​
method:'DELETE'
    }​​​​​​​​);
window.location.replace('/index.html');
